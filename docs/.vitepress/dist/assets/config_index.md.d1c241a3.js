...
<span class="line"></span></code></pre></div><h2 id="仓库代码各分支说明-后续将添加更多分支" tabindex="-1">仓库代码各分支说明（后续将添加更多分支） <a class="header-anchor" href="#仓库代码各分支说明-后续将添加更多分支" aria-hidden="true">#</a></h2><blockquote><p>项目切换分支后，<a href="http://README.md" target="_blank" rel="noreferrer">README.md</a> 文件内容都会不一样，请注意看 <a href="http://README.md" target="_blank" rel="noreferrer">README.md</a> 文件中的第一项 介绍 内容，会大概介绍当前分支是干啥的。<code>基础版同步 master 分支主版本</code></p></blockquote><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">├── vueNextAdmin</span></span>
