import{_ as s}from"./chunks/ccflowRightNextAdmin.31daa2db.js";import{_ as n,c as a,o as l,a as p}from"./app.e2317380.js";const m=JSON.parse('{"title":"简介","description":"","frontmatter":{},"headers":[{"level":2,"title":"长期赞助商","slug":"长期赞助商","link":"#长期赞助商","children":[]},{"level":2,"title":"目录结构图","slug":"目录结构图","link":"#目录结构图","children":[]},{"level":2,"title":"仓库代码各分支说明（后续将添加更多分支）","slug":"仓库代码各分支说明-后续将添加更多分支","link":"#仓库代码各分支说明-后续将添加更多分支","children":[]}],"relativePath":"config/index.md","lastUpdated":1677038214000}'),o={name:"config/index.md"},t=p('<h1 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-hidden="true">#</a></h1><div class="tip custom-block"><p class="custom-block-title">项目整体目录结构图介绍：</p><p><a href="https://gitee.com/lyt-top/vue-next-admin/tree/vue-prev-admin/" target="_blank" rel="noreferrer">vue-prev-admin</a> vue2.x 的目录结构也会基于该结构进行修改</p></div><h2 id="长期赞助商" tabindex="-1">长期赞助商 <a class="header-anchor" href="#长期赞助商" aria-hidden="true">#</a></h2><p>vueNextAdmin 是免费和开源的，由优秀的赞助商提供支持 ❤️。</p><a href="http://www.ccflow.org/" target="_black" class="next-sponsors-item"><img src="'+s+`" alt="驰骋流程+表单+低代码" title="驰骋流程+表单+低代码"></a><h2 id="目录结构图" tabindex="-1">目录结构图 <a class="header-anchor" href="#目录结构图" aria-hidden="true">#</a></h2><p>目录结构将 <code>定期更新</code>。树结构生成 cmd 输入 <code>tree</code> 或 <code>tree /f</code></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">├── vueNextAdmin</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	│	│   │   ├── </span><span style="color:#82AAFF;">breadcrumb</span><span style="color:#A6ACCD;"> (面包屑、关闭全屏、菜单搜索、布局配置、用户信息、消息通知)</span></span>
...
<span class="line"></span></code></pre></div><h2 id="仓库代码各分支说明-后续将添加更多分支" tabindex="-1">仓库代码各分支说明（后续将添加更多分支） <a class="header-anchor" href="#仓库代码各分支说明-后续将添加更多分支" aria-hidden="true">#</a></h2><p>项目切换分支后，<a href="http://README.md" target="_blank" rel="noreferrer">README.md</a> 文件内容都会不一样，请注意看 <a href="http://README.md" target="_blank" rel="noreferrer">README.md</a> 文件中的第一项 介绍 内容，会大概介绍当前分支是干啥的。<code>基础版同步 master 分支主版本</code></p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">├── vueNextAdmin</span></span>
...
<span class="line"></span></code></pre></div>`,11),e=[t];function A(c,r,C,y,D,F){return l(),a("div",null,e)}const u=n(o,[["render",A]]);export{m as __pageData,u as default};
